// --- Migrate Log ---
// 本次迁移修改:
// 在文件顶部加入迁移日志并引入 common_header.frag；补充对 iChannel0 的 sampler 声明以满足 common_header 要求；未改动算法。
// change summary:
// Added migration log and included common_header.frag; declared `uniform sampler2D iChannel0;` after include; no algorithm changes.
// -------------------
