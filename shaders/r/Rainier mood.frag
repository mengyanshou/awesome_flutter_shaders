// --- Migrate Log ---
// 迁移为 Flutter/Skia 兼容格式，顶部添加迁移日志和 include，补充 iChannel0 声明，所有局部变量显式初始化，底部 include main_shadertoy.frag。
// --- Migrate Log (EN) ---
// Migrated for Flutter/Skia compatibility: added migrate log and include at top, added iChannel0 declaration, explicit local variable initialization, include main_shadertoy.frag at bottom.
