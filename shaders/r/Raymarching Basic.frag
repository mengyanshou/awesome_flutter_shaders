// --- Migrate Log ---
// 迁移为 Flutter/Skia 兼容格式，顶部添加迁移日志和 include，所有局部变量显式初始化，for 循环变量用 int，底部 include main_shadertoy.frag。
// --- Migrate Log (EN) ---
// Migrated for Flutter/Skia compatibility: added migrate log and include at top, explicit local variable initialization, int for loop variable, include main_shadertoy.frag at bottom.
