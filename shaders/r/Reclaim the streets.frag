...
float t = 0.0, tt = 0.0, b = 0.0, bb = 0.0, g = 0.0, a = 0.0, la = 0.0;
vec2 z = vec2(0.0), v = vec2(0.0), e = vec2(.00035, -.00035);
vec3 pp = vec3(0.0), op = vec3(0.0), cp = vec3(0.0), po = vec3(0.0), no = vec3(0.0), al = vec3(0.0), ld = vec3(0.0);
vec4 np = vec4(0.0); 
