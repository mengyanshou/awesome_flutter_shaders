// --- Migrate Log ---
// 插入 Flutter/SkSL 公共 include；初始化局部 out 参数 `kk` 以防未定义行为；不修改原算法
// --- Migrate Log (EN) ---
// Add Flutter/SkSL common include; initialize local out parameter `kk` to avoid undefined behavior; keep original algorithm unchanged
