// --- Migrate Log ---
// 添加 common_header 引入并将浮点循环计数器改为整数计数器（例如在 calculateAO 中）以兼容 SkSL；在文件末尾添加 main include
// --- Migrate Log (EN) ---
// Added common_header include and converted float loop counters to integer counters (e.g. in calculateAO) for SkSL compatibility; appended main include at file end
