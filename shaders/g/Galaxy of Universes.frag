...
// 修复嵌套循环中的变量名冲突，内层循环计数器改名为 j
// 显式初始化变量以防止未定义行为
// Add required include directives for Flutter/Skia compatibility
// Fixed variable name conflict in nested loops, renamed inner counter to j
// Explicitly initialized all variables to prevent undefined behavior
