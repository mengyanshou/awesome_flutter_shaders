// --- Migrate Log ---
// Add common_header for Shadertoy uniforms (iResolution, iTime, etc.). No texture/filter changes needed.
// Ensure locals are explicitly initialized where required (no algorithm changes).
// --- Migrate Log (EN) ---
// Insert common_header to provide Shadertoy uniforms (iResolution, iTime...). No filter adaptations required.
// Make minimal, compatibility-only changes.
