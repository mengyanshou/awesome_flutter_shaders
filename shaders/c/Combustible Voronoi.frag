// --- Migrate Log ---
// 初始化局部变量（已检查，均已初始化）
// 添加 common header include，确保 Shadertoy uniforms 可用
//
// Initialize local variables (already checked they are initialized)
// Add common header include so Shadertoy uniforms are available
