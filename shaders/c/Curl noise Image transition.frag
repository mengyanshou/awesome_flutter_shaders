// --- Migrate Log ---
// 添加 Flutter/SkSL 公共 include，声明缺失的采样器 iChannel0 和 iChannel1；未改变原始噪声与 curl 算法
// --- Migrate Log (EN) ---
// Add Flutter/SkSL common include and declare missing samplers iChannel0 and iChannel1; no changes to original noise/curl algorithm
