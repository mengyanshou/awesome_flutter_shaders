...
// --- Migrate Log ---
// 兼容 Flutter/Skia：添加精度声明和 include，补齐 main_shadertoy.frag，显式初始化变量，移除 main() 包装，仅保留 mainImage。
// Flutter/Skia compatibility: added precision, includes, explicit var init, removed main() wrapper, kept mainImage only.
