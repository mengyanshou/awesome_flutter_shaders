...
vec3 draw_cloud(float f) {
    f = f * 0.5 + 0.5;
    return mix(vec3(8.0 / 255.0, 65.0 / 255.0, 82.0 / 255.0), vec3(178.0 / 255.0, 161.0 / 255.0, 205.0 / 255.0), f * f);
}
...
vec3 draw_marble(float f) {
    f = f * 0.5 + 0.5;
    return mix(vec3(31.0 / 255.0, 14.0 / 255.0, 4.0 / 255.0), vec3(172.0 / 255.0, 153.0 / 255.0, 138.0 / 255.0), 1.0 - pow(f, 3.));
}
