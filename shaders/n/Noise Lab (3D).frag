// --- Migrate Log ---
// 添加 Flutter 兼容性 include 和迁移日志
// 初始化 marching 函数中的 pos 和 d 变量
// 保持原始着色算法逻辑不变
// --- Migrate Log (EN) ---
// Add Flutter compatibility include and migration log
// Initialize pos and d variables in marching function
// Keep original shading algorithm logic unchanged
